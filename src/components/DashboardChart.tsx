...
export default function DashboardChart() {
    ...
    return (
      <div className="flex items-center justify-center h-[300px] bg-gray-50 dark:bg-gray-800 rounded-lg">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-2">Error loading metrics</p>
          <button 
  ...
  if (!Array.isArray(data.epochs) || !Array.isArray(data.train_loss) || !Array.isArray(data.val_loss)) {
    return (
      <div className="flex items-center justify-center h-[300px] bg-gray-50 dark:bg-gray-800 rounded-lg">
  ...
  const minLength = Math.min(data.epochs.length, data.train_loss.length, data.val_loss.length)
