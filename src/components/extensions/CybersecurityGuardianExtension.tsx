  ...
  const [alerts] = useState<ThreatAlert[]>([
    {
      ...
      severity: "critical",
      description:
        "Advanced ransomware variant detected targeting enterprise networks",
    ...
    },
    {
      ...
      severity: "high",
      description:
        "Sophisticated phishing campaigns leveraging AI-generated content",
    ...
    },
    {
      ...
      severity: "medium",
      description:
        "Botnet coordination detected in cryptocurrency mining operations",
    ...
    },
    {
      ...
      severity: "medium",
      description:
        "Coordinated misinformation campaign on social media platforms",
  ...
  return (
    <Box className="p-6 space-y-6">
      ...
      <Typography variant="body1" className="text-gray-600 dark:text-gray-300">
        Advanced threat detection powered by specialized BERT models including
        EvilBERT, RoBERTa, BERTroise, ThorBERT, and FakeBERT
      </Typography>
                      ...
                      secondary={
                        <Box>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            Model: {alert.model} | Source: {alert.source} |
                            Status: {alert.status}
                          </Typography>
                        </Box>
                      }
