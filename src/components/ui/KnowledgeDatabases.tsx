...
import { Storage, CloudUpload, DeleteOutline, InfoOutlined } from '@mui/icons-material';
    ...
    <ModernCard glass className="p-6">
      ...
      <Box className="space-y-6">
        {mockDatabases.map((db) => (
          <Box key={db.id} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <Box className="flex justify-between items-start mb-3">
              ...
              <Box className="flex items-center gap-2">
                ...
                <Tooltip title="Delete database">
                  <IconButton size="small" className="text-gray-400 hover:text-red-500">
            ...
            <Box className="space-y-1">
              <Box className="flex justify-between items-center mb-1">
                ...
                <Typography variant="caption" className="text-gray-600 dark:text-gray-300 font-medium">
                  {db.usagePercentage}%
                </Typography>
              </Box>
              <LinearProgress
